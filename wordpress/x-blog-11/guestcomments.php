...
<?php if ('open' == $post->comment_status) : ?>
<div class="replyForm">
<h3 id="respond">Sign My Guestbook</h3>
...
<p><textarea name="comment" id="comment"  tabindex="4" style="width: 400PX; height: 150px;"></textarea></p>

<p><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Guestbook Entry" />
